...
{
    /// <summary>
    /// Класс ClsFilters предоставляет методы для фильтрации входных данных и обработки значений с использованием различных фильтров и эффектов.
    /// </summary>
    public class ClsFilters
    {
        ...
        /// <summary>
        /// Применяет фильтр экспоненциального скользящего среднего (EMA) к входному значению для симуляции зоны затухания до нуля.
        /// </summary>
        /// <param name="value">Входное значение для обработки.</param>
        ...
        /// <summary>
        /// Выполняет сглаживание входного значения с использованием фильтра "Сглаживание" (Smoothing) с учетом знака (положительное или отрицательное).
        /// </summary>
        /// <param name="value">Входное значение для сглаживания.</param>
